...
f = open('config/departments.json','r')
...
def get_true_intent(message, records):
    ...
    if pre_action in ['action_ask_free_date_5']:
    ...
    if pre_action in ['action_ask_name_6']: 
    ...
    if pre_action in ['action_ask_gender_7']:
    ...
    if pre_action in ["action_ask_age_8"]:
